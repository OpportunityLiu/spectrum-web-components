...
import { findAccessibilityNode } from '../../../test/testing-helpers.js';
...
describe('Combobox', () => {
    describe('renders accessibly', () => {
        ...
        xit('manages aria-activeDescendent', async () => {});
        xit('manages aria-selected', async () => {});
        xit('manages aria-expanded', async () => {});
    });
    ...
    describe('responds to value changes', () => {
        ...
        it('filters options when the value changes and is not found', async () => {
            ...
            const options = [
                ...el.shadowRoot.querySelectorAll('sp-combobox-item'),
            ];
        ...
        it('filters options when the value typed and is found', async () => {
            ...
            let items = [
                ...el.shadowRoot.querySelectorAll('#listbox sp-combobox-item'),
            ];
